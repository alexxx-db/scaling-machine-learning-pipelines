...
# MAGIC 
# MAGIC <img alt="Side Note" title="Side Note" style="vertical-align: text-bottom; position: relative; height:1.75em; top:0.05em; transform:rotate(15deg)" src="https://files.training.databricks.com/static/images/icon-note.webp"/> When using Databricks Runtime for Machine Learning 8.0 or greater, Spark DataFrames will write using Delta by default.
...
# MAGIC 
# MAGIC <img alt="Hint" title="Hint" style="vertical-align: text-bottom; position: relative; height:1.75em; top:0.3em" src="https://files.training.databricks.com/static/images/icon-light-bulb.svg"/>&nbsp;**Hint:** Be sure to exclude the target variable from this step!
...
# MAGIC 
# MAGIC <img alt="Side Note" title="Side Note" style="vertical-align: text-bottom; position: relative; height:1.75em; top:0.05em; transform:rotate(15deg)" src="https://files.training.databricks.com/static/images/icon-note.webp"/> You can read more about [estimators](https://spark.apache.org/docs/latest/ml-pipeline.html#estimators) and [transformers](https://spark.apache.org/docs/latest/ml-pipeline.html#transformers) in the Spark MLlib documentation.
# MAGIC 
# MAGIC #### Fit the `Imputer` estimator on the DataFrame
# MAGIC 
# MAGIC Now, we'll perform the imputation.
# MAGIC 
# MAGIC <img alt="Hint" title="Hint" style="vertical-align: text-bottom; position: relative; height:1.75em; top:0.3em" src="https://files.training.databricks.com/static/images/icon-light-bulb.svg"/>&nbsp;**Hint:** Be sure to import from `pyspark.ml` for the DataFrame-based Spark MLlib API.
# MAGIC 
...
# MAGIC 
# MAGIC <img alt="Side Note" title="Side Note" style="vertical-align: text-bottom; position: relative; height:1.75em; top:0.05em; transform:rotate(15deg)" src="https://files.training.databricks.com/static/images/icon-note.webp"/> If we tried to pass in a list of column names, we'd get an error when working with most model types in Spark MLlib.
